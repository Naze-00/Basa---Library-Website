        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="section-title">
                    <h1 class="display-4 fw-semibold">Publishers</h1>
                    <div class="li"></div>
                    <h6>List of all Publishers</h6>
                </div>
            </div>
        </div>

        <a href="add_new_publishers.php" class="btn btn-dark mb-3">Add new</a>
        <div class="row justify-content-center ">
            <div class="col-md-6">
                <input type="text" id="search-input" class="form-control" placeholder="Search by Company...">
            </div>
        </div>
        <?php
        if (isset($_GET['msg'])) {
        ...
        <table class="table table-hover text-center mt-4">
            <thead class="table-dark">
                <tr>
                    ...
                    <th scope="col">Publisher Company</th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $row['PublisherCompany'] ?></td>
                        <td><?php echo $row['Contact'] ?></td>
                        <td><?php echo $row['Address'] ?></td>

                        <td>
                            <a href="edit_publishers.php?id=<?php echo $row['PublisherID'] ?>" class="link-dark"><i class="ri-edit-fill"></i></a>
                            <a href="delete_publishers.php?id=<?php echo $row['PublisherID'] ?>" class="link-dark"><i class="ri-delete-bin-5-fill"></i></a>
                        </td>
                    </tr>
                <?php
                }
