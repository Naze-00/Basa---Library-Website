        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="section-title">
                    <h1 class="display-4 fw-semibold">Librarian</h1>
                    <div class="li"></div>
                    <h6>List of all librarian</h6>
                </div>
            </div>
        </div>

        <a href="add_new_librarian.php" class="btn btn-dark mb-3">Add new</a>
        <div class="row justify-content-center ">
            <div class="col-md-6">
                <input type="text" id="search-input" class="form-control" placeholder="Search by First Name...">
            </div>
        </div>
        <?php
        if (isset($_GET['msg'])) {
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_librarian.php?id=<?php echo $row['LibrarianId'] ?>" class="link-dark"><i class="ri-edit-fill"></i></a>
                            <a href="delete_librarian.php?id=<?php echo $row['LibrarianId'] ?>" class="link-dark"><i class="ri-delete-bin-5-fill"></i></a>
                        </td>
                    </tr>
                <?php
                }
