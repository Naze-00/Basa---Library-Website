        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="section-title">
                    <h1 class="display-4 fw-semibold">Users</h1>
                    <div class="li"></div>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit.php?id=<?php echo $row['ClientID'] ?>" class="link-dark"><i class="ri-edit-fill"></i></a>
                            <a href="delete.php?id=<?php echo $row['ClientID'] ?>" class="link-dark"><i class="ri-delete-bin-5-fill"></i></a>
                        </td>
                    </tr>
                <?php
                }
