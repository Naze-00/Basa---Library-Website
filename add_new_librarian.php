...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `librarian`(`LibrarianId`, `FirstName`, `LastName`, `Email`, `Pass`) VALUES (NULL,'$first_name','$last_name','$email','$password')";

    $result = mysqli_query($conn, $sql);

    if($result){
        header("Location: ./librarian.php ?msg=New Record created successfully!");
    }
    else{
