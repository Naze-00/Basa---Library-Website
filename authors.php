        ...
        <div class="row">
            <div class="col-12 text-center">
                <div class="section-title">
                    <h1 class="display-4 fw-semibold">Authors</h1>
                    <div class="li"></div>
                    <h6>List of all Authors</h6>
                </div>
            </div>
        </div>

        <a href="add_new_authors.php" class="btn btn-dark mb-3">Add new</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="edit_authors.php?id=<?php echo $row['AuthorID'] ?>" class="link-dark"><i class="ri-edit-fill"></i></a>
                            <a href="delete_authors.php?id=<?php echo $row['AuthorID'] ?>" class="link-dark"><i class="ri-delete-bin-5-fill"></i></a>
                        </td>
                    </tr>
                <?php
                }
